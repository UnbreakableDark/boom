...
//{data=animeCarousel,typeList=amimeList}
function ZArea(props){
    const [carouselList,setCarouselList]=useState(props.data);
    const [dataList,setDataList]=useState(props.typeList.slice(0,4))
    return (
